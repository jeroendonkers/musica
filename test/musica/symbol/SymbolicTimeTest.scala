...
class SymbolicTimeTest {
  ...
  @Test def timetest1() {
   ...
   @Test def implicittest1() {
    val t:  SymbolicTime =  3\4
    assertEquals(3\4, t)
    
     val s:  SymbolicTime =  3
     assertEquals(3\1, s)
  ...
  @Test def testmetrum() {
    ...
    assertEquals(SymbolicTime(13\8), m.getBarValue(1,5\2))
